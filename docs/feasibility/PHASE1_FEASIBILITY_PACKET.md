...
| Evidence v0.1 | `schemas/tmg_ekg_evidence_v0_1.schema.json` | Adds **`edge_type_counts`**, **`conditional_edge_zero_reasons`**, **`lane_tag_counts`**, **`rule_pack_version`** (const **`UPG-GOV-TMG-EKG-GRAPH-QUALITY-PHASE1C-001-R4`**). Indexer: **`tmg-ekg-index run --emit-version v0_1`** after governance **rule-pack GO**; default remains **v0**. |
